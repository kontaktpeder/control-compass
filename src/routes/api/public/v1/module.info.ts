        ...
        return Response.json(
          withContract({
            ...
            endpoints: {
              ...
              agreements: `${base}/api/public/v1/agreements`,
              agreement: `${base}/api/public/v1/agreements/{id}`,
            },
            scopes: {
              organization: ["platform:read"],
              organization_verify: ["platform:verify"],
              widgets: ["platform:read"],
              agreements_create: ["agreements:write", "platform:read"],
              agreements_read: ["agreements:read", "platform:read"],
            },
