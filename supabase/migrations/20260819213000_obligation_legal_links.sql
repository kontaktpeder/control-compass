...
UPDATE public.obligations SET
  legal_citation = 'Aksjeloven § 2-8',
  legal_url = 'https://lovdata.no/dokument/NL/lov/1997-06-13-44/%C2%A72-8'
...
UPDATE public.obligations SET
  legal_citation = 'Bokføringsloven § 5',
  legal_url = 'https://lovdata.no/dokument/NL/lov/2004-07-02-73/%C2%A75'
WHERE title = 'Business Bank Account';

UPDATE public.obligations SET
  legal_citation = 'Bokføringsloven § 3',
  legal_url = 'https://lovdata.no/dokument/NL/lov/2004-07-02-73/%C2%A73'
...
UPDATE public.obligations SET
  legal_citation = 'Aksjeloven § 5-6',
  legal_url = 'https://lovdata.no/dokument/NL/lov/1997-06-13-44/%C2%A75-6'
WHERE title = 'Annual General Meeting Minutes';

UPDATE public.obligations SET
  legal_citation = 'Regnskapsloven § 3-3',
  legal_url = 'https://lovdata.no/dokument/NL/lov/1998-07-17-56/%C2%A73-3'
...
begin
  ...
  insert into public.sources(org_id, framework_id, authority, reference, url) values
    (_org, fw_acct, 'Bookkeeping Act (Bokføringsloven)', 'LOV-2004-07-02-73', 'https://lovdata.no/dokument/NL/lov/2004-07-02-73') returning id into src_bok;
  insert into public.sources(org_id, framework_id, authority, reference, url) values
  ...
  insert into public.obligations (org_id, framework_id, source_id, playbook_step_id, title, why, responsible, evidence_requirements, is_required, legal_citation, legal_url) values
    ...
    (_org, fw_corp, src_asa, s1, 'Share Capital Confirmation',
      ...
      'Aksjeloven § 2-8', 'https://lovdata.no/dokument/NL/lov/1997-06-13-44/%C2%A72-8'),
  ...
  insert into public.obligations (org_id, framework_id, source_id, playbook_step_id, title, why, responsible, evidence_requirements, is_required, legal_citation, legal_url) values
    (_org, fw_acct, src_bok, s2, 'Business Bank Account',
      'A separate business bank account is required to keep company funds separate from private funds and to satisfy bookkeeping rules.',
      'Managing Director', array['Bank account confirmation'], true,
      'Bokføringsloven § 5', 'https://lovdata.no/dokument/NL/lov/2004-07-02-73/%C2%A75'),
    (_org, fw_acct, src_bok, s2, 'Accounting System Active',
      'The Bookkeeping Act requires a bookkeeping system from day one — transactions must be recorded chronologically.',
      'Accountant', array['Accounting system agreement or invoice'], true,
      'Bokføringsloven § 3', 'https://lovdata.no/dokument/NL/lov/2004-07-02-73/%C2%A73'),
  ...
  insert into public.obligations (org_id, framework_id, source_id, playbook_step_id, title, why, responsible, evidence_requirements, is_required, legal_citation, legal_url) values
    (_org, fw_gov, src_asa, s5, 'Annual General Meeting Minutes',
      ...
      'Aksjeloven § 5-6', 'https://lovdata.no/dokument/NL/lov/1997-06-13-44/%C2%A75-6'),
    (_org, fw_acct, src_book, s5, 'Annual Accounts Submitted',
      ...
      'Regnskapsloven § 3-3', 'https://lovdata.no/dokument/NL/lov/1998-07-17-56/%C2%A73-3');
end $function$;
